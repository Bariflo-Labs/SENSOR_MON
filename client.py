...
class iotMQTT:
    ...
    def lp(c):
        ...
        try :
            c.client.connect_async(broker_address,port=1883, keepalive=10) #connect to broker
    ...
    def postDataFeed(c,dt):
        dt["deviceId"]= c.subscriptionId
        dtStr = json.dumps(dt)
        c.client.publish("iot.server.datafeed.topic",dtStr)
